...
class MultiSelectWithStdin extends _react.PureComponent {
  render() {
    return _react.default.createElement(_ink.StdinContext.Consumer, null, ({
      stdin,
      setRawMode
    }) => _react.default.createElement(MultiSelect, _extends({}, this.props, {
      stdin: stdin,
...
exports.default = MultiSelectWithStdin;